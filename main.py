...
def class_creator(name, parent, class_attr1, class_attr2, class_attr3):
    ...
    parent = parent_dict.get(class_attr3, Animal)
...
pet = {individual: [variety[1][5](individual), variety[0]] for variety in animals.items() for individual in variety[1][0]}

#Получаем список животных на ферме:

for individual in pet.items():
    print(f'Вид животного: {individual[1][0].animal_type}\nИмя животного: {individual[1][0].animal_name}')
